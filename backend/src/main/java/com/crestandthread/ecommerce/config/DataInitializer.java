...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeProducts() {
        ...
        createProduct("CT-KW-001", "Cashmere Crew Sweater", knitwear,
                "Luxuriously soft cashmere sweater with a classic crew neck design. Perfect for layering or wearing alone.",
        ...
        createProduct("CT-OW-001", "Tailored Wool Coat", outerwear,
                "Impeccably tailored wool coat with a modern silhouette. A timeless investment piece.",
        ...
        createProduct("CT-ES-001", "Classic White Tee", essentials,
                "The perfect white t-shirt. Premium cotton, relaxed fit, and exceptional quality.",
                new BigDecimal("45.00"), null,
                "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=500&fit=crop",
                false, false);

        createProduct("CT-DN-001", "Selvedge Denim Jeans", denim,
                "Premium selvedge denim crafted in Japan. Raw denim that develops character over time.",
        ...
        createProduct("CT-KW-002", "Merino Wool Cardigan", knitwear,
                "Fine merino wool cardigan with mother of pearl buttons. Lightweight and versatile.",
        ...
        createProduct("CT-OW-002", "Leather Bomber Jacket", outerwear,
                "Classic leather bomber jacket with ribbed cuffs. Butter-soft lamb leather.",
                new BigDecimal("495.00"), null,
                "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=400&h=500&fit=crop",
                true, true);

        createProduct("CT-ES-002", "Oxford Button-Down Shirt", essentials,
                "Classic oxford cloth button-down shirt. A wardrobe essential.",
        ...
        createProduct("CT-DN-002", "Slim Fit Chinos", denim,
                "Perfectly fitted chinos in premium stretch cotton. Comfortable all-day wear.",
